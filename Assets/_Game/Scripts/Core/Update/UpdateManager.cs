        ...
        public bool CheckIfAttached(ITicker ticker)
        {
            ...
            switch (ticker.Priority)
            {
                case Priority.High:
                {
                    ...
                    Debug.LogErrorFormat("The amount of tick objects with high priority was exceeded", ticker);
                ...
                case Priority.Low:
                {
                    ...
                    Debug.LogErrorFormat("The amount of tick objects with low priority was exceeded", ticker);
        ...
        public bool CheckIfDetached(ITicker ticker)
        {
            switch (ticker.Priority)
            {
                case Priority.High:
                {
                    ...
                    Debug.LogErrorFormat("Failed to detach the objects with high tick priority", ticker);
                ...
                case Priority.Normal:
                {
                    ...
                    Debug.LogErrorFormat("Failed to detach the objects with normal tick priority", ticker);
                ...
                case Priority.Low:
                {
                    ...
                    Debug.LogErrorFormat("Failed to detach the objects with low tick priority", ticker);
